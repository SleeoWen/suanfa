...
var maxIncreaseKeepingSkyline = function (grid) {
  ...
  const rows = new Array(rowNum).fill(0);
  const cols = new Array(colNum).fill(0);
  grid.forEach((item, index) => {
    rows[index] = Math.max(...item);
  })
...
// const temo = [[3, 0, 8, 4], [2, 4, 5, 7], [9, 2, 6, 3], [0, 3, 1, 0]]
// console.log(maxIncreaseKeepingSkyline(temo));
