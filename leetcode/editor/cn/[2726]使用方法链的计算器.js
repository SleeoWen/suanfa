//设计一个类 Calculator 。该类应提供加法、减法、乘法、除法和乘方等数学运算功能。同时，它还应支持连续操作的方法链式调用。Calculator 类的
//构造函数应接受一个数字作为 result 的初始值。 
//
...
// divide - 将 result 除以给定的数字 value ，并返回更新后的 Calculator 对象。如果传入的值为 0 ，则抛出错误 
//"Division by zero is not allowed" 。 
// power - 计算 result 的幂，指数为给定的数字 value ，并返回更新后的 Calculator 对象。（result = result ^
// value ） 
// getResult - 返回 result 的值。 
// 
//
// 结果与实际结果相差在 10⁻⁵ 范围内的解被认为是正确的。 
//
// 
//
// 示例 1： 
...
// actions[i] 是 "Calculator", "add", "subtract", "multiply", "divide", "power", 
//和 "getResult" 其中的元素 
// 第一个操作总是 "Calculator" 
// 最后一个操作总是 "getResult" 
// 
